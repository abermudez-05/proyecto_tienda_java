...
public class UsuariosREST {
	...
	public String registrar(String nombre, String email, String pass, String telefono, String nickname){
		System.out.println("voy a registrar: " + nombre + " | " + email + " | " + pass);
		if(servicioUsuarios.obtenerUsuarioPorEmail(email) != null) {
			return "email ya registrado";
		}
		servicioUsuarios.registrarUsuario(new Usuario(nombre, pass, email, telefono, nickname));
